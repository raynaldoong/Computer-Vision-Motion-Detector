...
5. Creates a Thershold Frame which determines when the difference in first frame and following frame is more than 30 using cv2.THRESH_BINARY <img src="images/Threshold Frame.png" alt="threshold" width="800"/>
